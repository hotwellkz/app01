...
export const CategoryCard: React.FC<CategoryCardProps> = ({ 
  ...
  const handleDelete = async (deleteAll: boolean = false) => {
    try {
      ...
      // Если выбрано удаление всех данных
      if (deleteAll) {
        // Находим и удаляем все транзакции
        ...
        // Находим и удаляем все связанные категории
      ...
      // Вызываем колбэк для обновления состояния родительского компонента
      if (onDelete) {
